<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%" max-height="530">
      ...
      <el-table-column align="center" label="浏览器" width="180">
        <template slot-scope="scope">
        ...
        <el-row :gutter="24">
          <el-col :span="9">
            <el-form-item :label-width="formLabelWidth" label="邮箱" prop="email">
              <el-input auto-complete="off" style="width:150px" v-model="form.email"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="评论状态" :label-width="formLabelWidth" prop="commentStatus">
              <el-select placeholder="请选择" style="width:75px" v-model="form.commentStatus">
                <el-option
                  :key="item.uid"
                  :label="item.dictLabel"
          ...
          <el-col :span="6">
            <el-form-item label="用户标签" :label-width="formLabelWidth" prop="userTag">
              <el-select placeholder="请选择" style="width:105px" v-model="form.userTag">
                <el-option
                  :key="item.uid"
                  :label="item.dictLabel"
                  :value="parseInt(item.dictValue)"
